 ...
 */
export { CREATE_VARIANT_QUERY } from "./queries/productVariant/createVariant";
...
export { UPDATE_PRODUCT_OPTION_AND_VARIANTS_QUERY } from "./queries/productOption/updateProductOptionAndVariants.ts";
